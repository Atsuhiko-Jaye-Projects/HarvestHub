<div class="modal fade" id="recieve-order-modal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <p class="text-muted mb-0">
          ...
          Are you sure you want to recieve this Order?  
      ...
      <div class="modal-footer border-0">
        ...
        <button type="button" class="btn btn-primary" id="confirmOrderProduct">
