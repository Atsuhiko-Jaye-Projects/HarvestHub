          ...
          <div class="card-body">
            <div class="container">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <Label>Price</Label>
                  <input type="text" name="price_per_unit" value="<?php echo $price_per_unit; ?>" class="form-control" required placeholder="Lot Size">
                </div>
                <div class="col-md-6">
                  <Label>Unit</Label>
                  <input type="text" name="unit" value="<?php echo $unit; ?>" class="form-control" required placeholder="Lot Size">
                </div>
              </div>
